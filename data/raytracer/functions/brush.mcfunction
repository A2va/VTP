...
execute if entity @s[scores={ChoiceTree=2}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/birch_custom
execute if entity @s[scores={ChoiceTree=3}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/birch
execute if entity @s[scores={ChoiceTree=4}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/dark_oak
execute if entity @s[scores={ChoiceTree=5}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/jungle_big
execute if entity @s[scores={ChoiceTree=6}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/jungle_custom
execute if entity @s[scores={ChoiceTree=7}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/jungle_small
execute if entity @s[scores={ChoiceTree=8}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/jungle
execute if entity @s[scores={ChoiceTree=9}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/oak_big
execute if entity @s[scores={ChoiceTree=10}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/oak_custom
execute if entity @s[scores={ChoiceTree=11}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/oak
execute if entity @s[scores={ChoiceTree=12}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/oak_small
execute if entity @s[scores={ChoiceTree=13}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/spruce_custom
execute if entity @s[scores={ChoiceTree=14}] unless block ~ ~ ~ #raytracer:transparent run function raytracer:tree/spruce



execute if entity @s[scores={ChStencils=0}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_0
execute if entity @s[scores={ChStencils=1}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_1
execute if entity @s[scores={ChStencils=2}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_2
execute if entity @s[scores={ChStencils=3}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_3
execute if entity @s[scores={ChStencils=4}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_4
execute if entity @s[scores={ChStencils=5}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_5
execute if entity @s[scores={ChStencils=6}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_6
execute if entity @s[scores={ChStencils=7}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_7
execute if entity @s[scores={ChStencils=8}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_8
execute if entity @s[scores={ChStencils=9}] unless block ~ ~ ~ #raytracer:transparent run function stencils:list_stencil/stencils_9
