...
execute if score loaded Chunk matches 0 run tellraw @a ["",{"text":"Chunk 0,-1 wasn't loaded. Try again (or use "},{"text":"/forceload add 0 -1","clickEvent":{"action":"suggest_command","value":"/forceload add 0 -1"},"color":"aqua","underlined":true},{"text":")","color":"white"}]
