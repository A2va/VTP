...
scoreboard players set BrushR7 gravel_percent 173
scoreboard players set hundred gravel_percent 100



scoreboard players operation @e[type=area_effect_cloud,tag=centerGravel] gravel_loop = BrushR7 gravel_percent
...
execute as @e[type=area_effect_cloud,tag=centerGravel] at @s run function raytracer:brushsize/gravel/gravel_loop_r7
