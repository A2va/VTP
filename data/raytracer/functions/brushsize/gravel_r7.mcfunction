...
scoreboard players operation @e[type=armor_stand,name=centerGravel] gravel_loop = BrushR7 gravel_percent
...
execute as @e[type=armor_stand,name=centerGravel] at @s run function raytracer:brushsize/gravel/gravel_loop_r7
