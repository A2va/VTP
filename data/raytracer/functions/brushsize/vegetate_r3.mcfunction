...
scoreboard players operation @e[type=area_effect_cloud,tag=centerVegetate] vegetate_loop = BrushR3 vegetate_percent
...
execute as @e[type=area_effect_cloud,tag=centerVegetate] at @s run function raytracer:brushsize/vegetate/vegetate_loop_r3
