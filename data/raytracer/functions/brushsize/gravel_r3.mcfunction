...
scoreboard players operation @e[type=area_effect_cloud,tag=centerGravel] gravel_loop = BrushR3 gravel_percent
...
execute as @e[type=area_effect_cloud,tag=centerGravel] at @s run function raytracer:brushsize/gravel/gravel_loop_r3
