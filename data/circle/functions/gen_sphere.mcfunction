...
scoreboard players operation @e[type=area_effect_cloud,tag=sphereGen,sort=nearest,limit=1] Rad = @s sphere
...
execute as @e[type=area_effect_cloud,tag=sphereGen,sort=nearest,limit=1] run function circle:sphere_gen/gen
...
execute as @s at @s run function circle:tp_up/tp_sphere
