...
#execute if score plot SetBlock matches 1 as @s at @s run function raycasting:set_plot/clone_mask
#execute if score plot SetBlock matches 0 as @s at @s run function raycasting:set_plot/clone_material
