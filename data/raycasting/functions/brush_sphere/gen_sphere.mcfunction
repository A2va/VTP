...
scoreboard players operation @e[type=area_effect_cloud,tag=sphereGen,sort=nearest,limit=1] Rad = @s test
...
execute as @e[type=area_effect_cloud,tag=sphereGen,sort=nearest,limit=1] run function raycasting:brush_sphere/gen
...
execute as @e[type=area_effect_cloud,tag=brush] run setblock ~ ~ ~ stone


kill @e[type=area_effect_cloud,tag=brush]
