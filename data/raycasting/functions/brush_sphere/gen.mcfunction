...
execute as @s at @s if entity @s[scores={operation=..0}] run summon area_effect_cloud ~ ~ ~ {Tags:["brush"],Duration:2147483647}
...
execute as @s at @s if entity @s[scores={operation=0..}] run function raycasting:brush_sphere/gen
