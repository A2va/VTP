...
execute as @e[type=area_effect_cloud,tag=sphereGen,sort=nearest,limit=1] run function raycasting:shape/hsphere_gen/gen
...
#execute as @s at @s run function raycasting:shape/tp_up/tp_hsphere
