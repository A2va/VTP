...
execute as @e[type=area_effect_cloud,tag=circleGen,tag=X+] at @s run function raycasting:shape/dist_tp/dist_tp_xp
execute as @e[type=area_effect_cloud,tag=circleGen,tag=X-] at @s run function raycasting:shape/dist_tp/dist_tp_xm
execute as @e[type=area_effect_cloud,tag=circleGen,tag=Z+] at @s run function raycasting:shape/dist_tp/dist_tp_zp
execute as @e[type=area_effect_cloud,tag=circleGen,tag=Z-] at @s run function raycasting:shape/dist_tp/dist_tp_zm
...
execute as @e[type=area_effect_cloud,tag=circleGen,tag=X+] at @s run function raycasting:shape/circle_gen/gen_xp
scoreboard players set temp percent_vtp 0
execute as @e[type=area_effect_cloud,tag=circleGen,tag=X-] at @s run function raycasting:shape/circle_gen/gen_xm
scoreboard players set temp percent_vtp 0
execute as @e[type=area_effect_cloud,tag=circleGen,tag=Z+] at @s run function raycasting:shape/circle_gen/gen_zp
scoreboard players set temp percent_vtp 0
execute as @e[type=area_effect_cloud,tag=circleGen,tag=Z-] at @s run function raycasting:shape/circle_gen/gen_zm
