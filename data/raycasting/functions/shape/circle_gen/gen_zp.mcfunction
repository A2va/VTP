...
execute as @s at @s run function raycasting:shape/circle_gen/block_mask_zp

scoreboard players add blockCount blockCount 1

execute as @s at @s if entity @s[scores={circlePos1=0..}] run function raycasting:shape/circle_gen/gen_zp
