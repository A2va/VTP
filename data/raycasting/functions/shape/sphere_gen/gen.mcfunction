...
execute as @s at @s if entity @s[scores={operation=..0}] run function raycasting:shape/block_mask
...
execute as @s at @s if entity @s[scores={operation=0..}] run function raycasting:shape/sphere_gen/gen
