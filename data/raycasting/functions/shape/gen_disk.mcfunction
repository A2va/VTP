...
execute as @e[type=area_effect_cloud,tag=diskGen] at @s run function raycasting:shape/dist_tp/dist_tp_xm
execute as @e[type=area_effect_cloud,tag=diskGen,sort=nearest,limit=1] run scoreboard players operation @s tempRad = @s Rad
execute as @e[type=area_effect_cloud,tag=diskGen] at @s run function raycasting:shape/dist_tp/dist_tp_zm
...
execute as @e[type=area_effect_cloud,tag=diskGen,sort=nearest,limit=1] run function raycasting:shape/disk_gen/gen
