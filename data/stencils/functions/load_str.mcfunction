...
execute if score Global structure_sizeX matches 1 run scoreboard players add Global structure_size 1
execute if score Global structure_sizeY matches 1 run scoreboard players add Global structure_size 1
execute if score Global structure_sizeZ matches 1 run scoreboard players add Global structure_size 1
...
execute if score Global structure_size matches 0..2 run tellraw @a ["",{"text":"["},{"text":"FAILED","color":"red"},{"text":"] "},{"text":"You're selection needs to be 1x1x1!"}]

execute if score Global structure_pos matches 3 if score Global structure_size matches 3 run setblock ~ ~ ~ structure_block[mode=load]{name:"structure",author:"BlingEdit",rotation:"NONE",mirror:"NONE",mode:"LOAD"}
...
execute if score Global structure_pos matches 3 if score Global structure_size matches 3 run tellraw @a ["",{"text":"["},{"text":"OK","color":"green"},{"text":"] "},{"text":"Structure loaded!"}]
