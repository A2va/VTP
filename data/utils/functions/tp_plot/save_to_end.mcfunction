...
#Save Plot
execute in minecraft:the_end run setblock 5 252 -14 minecraft:structure_block{mode:"SAVE",name:"raycasting:plot",posX:0,posY:1,posZ:0,sizeX:7,sizeY:2,sizeZ:13,showboundingbox:0b}
